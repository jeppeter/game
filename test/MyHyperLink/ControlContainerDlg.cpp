...
BOOL CControlContainerDlg::OnInitDialog()
{
	...
	//Set the Tooltiptext
	m_Static1.SetTootTipText(TEXT("Click Here to go Codeproject"));
	...
	m_Static2.SetTootTipText(TEXT("Click here to Email Me.."));


	m_Static3.SetFireChild(1);
	m_Static3.ActiveToolTip(1);
	m_Static3.SetTootTipText(TEXT("Click Here to Fire An event to parent"));
...
LRESULT CControlContainerDlg::OnChildFire(WPARAM wparam,LPARAM lparam)
{
	CString csTmp;
	csTmp.Format(TEXT(" Child Fire Me ====>>with resource ID(#%d)"),(int)wparam);
